...
Write-Host "============================================================" -ForegroundColor Green
Write-Host ""
Write-Host "Some resources may have failed if they:" -ForegroundColor Gray
Write-Host "  - Already exist in state" -ForegroundColor Gray
Write-Host "  - Don't exist in AWS" -ForegroundColor Gray
Write-Host "  - Have different names" -ForegroundColor Gray
Write-Host ""
